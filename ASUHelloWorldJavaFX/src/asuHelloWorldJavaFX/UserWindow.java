...
public class UserWindow extends Stage {
    ...
    @FXML
    ComboBox<String> lifeCycleCombo;
    @FXML
    ComboBox<String> effortCategoryCombo;
    @FXML
    ComboBox<String> typeOfEffortCombo;
    @FXML
    Label clockTextBox;
    @FXML
    Label typeOfEffortText;
    @FXML
    Rectangle rectangleItem;
    @FXML
    Label choiceFieldsText = new Label("Please select a choice for all fields");
    ...
    private void updateLifeCycleOptions(String project) {
        ...
        if ("Business Project".equals(project)) {
            lifeCycleCombo.getItems().addAll("", "Planning", "Information Gathering", "Information Understanding",
                    "Verifying", "Outlining", "Drafting", "Finalizing", "Team Meeting", "Coach Meeting",
                    "Stakeholder Meeting");
        } else if ("Development Project".equals(project)) {
            lifeCycleCombo.getItems().addAll("", "Problem Understanding", "Conceptual Design Plan", "Requirements",
                    ...
                    "Test Case Generation", "Solution Review", "Solution Implementation", "Unit/System	Test",
    ...
    private void updateTypeOfEffortOptions(String effortCategory) {
        ...
        if ("Plans".equals(effortCategory)) {
            typeOfEffortCombo.getItems().addAll("", "Project Plan", "Risk Management Plan", "Conceptual Design Plan",
                    "Detailed Design Plan", "Implementation Plan");
        } else if ("Deliverables".equals(effortCategory)) {
            typeOfEffortCombo.getItems().addAll("", "Conceptual Design", "Detailed Design", "Test Cases", "Solution",
                    "Refelection", "Outline", "Draft", "Report", "User Defined", "Other");
